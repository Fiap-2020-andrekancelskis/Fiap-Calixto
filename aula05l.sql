...
-- criando a p rocedure aula 05
create or replace procedure todos_clientes(cursor_saida OUT sys_refcursor) as 

    
begin
    open cursor_saida for
    select id_cliente, nome, sobrenome, obs, data_nasc from cliente;
end;